...
pub const APPX_ENCRYPTED_PACKAGE_OPTIONS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(APPX_ENCRYPTED_PACKAGE_OPTIONS, (if (o.NONE == 1) @intFromEnum(APPX_ENCRYPTED_PACKAGE_OPTIONS.NONE) else 0) | (if (o.DIFFUSION == 1) @intFromEnum(APPX_ENCRYPTED_PACKAGE_OPTIONS.DIFFUSION) else 0) | (if (o.PAGE_HASHING == 1) @intFromEnum(APPX_ENCRYPTED_PACKAGE_OPTIONS.PAGE_HASHING) else 0));
    }
};
