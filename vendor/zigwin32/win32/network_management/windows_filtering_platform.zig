...
pub const IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS, @enumFromInt((if (o.LOCAL_AUTH_ONLY == 1) @intFromEnum(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS.LOCAL_AUTH_ONLY) else 0) | (if (o.REMOTE_AUTH_ONLY == 1) @intFromEnum(IKEEXT_PRESHARED_KEY_AUTHENTICATION_FLAGS.REMOTE_AUTH_ONLY) else 0)));
    }
};
...
pub const IKEEXT_POLICY_FLAG = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_POLICY_FLAG, @enumFromInt((if (o.DISABLE_DIAGNOSTICS == 1) @intFromEnum(IKEEXT_POLICY_FLAG.DISABLE_DIAGNOSTICS) else 0) | (if (o.NO_MACHINE_LUID_VERIFY == 1) @intFromEnum(IKEEXT_POLICY_FLAG.NO_MACHINE_LUID_VERIFY) else 0) | (if (o.NO_IMPERSONATION_LUID_VERIFY == 1) @intFromEnum(IKEEXT_POLICY_FLAG.NO_IMPERSONATION_LUID_VERIFY) else 0) | (if (o.ENABLE_OPTIONAL_DH == 1) @intFromEnum(IKEEXT_POLICY_FLAG.ENABLE_OPTIONAL_DH) else 0)));
    }
};
...
pub const IKEEXT_RESERVED_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_RESERVED_AUTHENTICATION_FLAGS, @enumFromInt((if (o.N == 1) @intFromEnum(IKEEXT_RESERVED_AUTHENTICATION_FLAGS.N) else 0)));
    }
};
...
pub const IKEEXT_EAP_AUTHENTICATION_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @as(IKEEXT_EAP_AUTHENTICATION_FLAGS, @enumFromInt((if (o.LOCAL_AUTH_ONLY == 1) @intFromEnum(IKEEXT_EAP_AUTHENTICATION_FLAGS.LOCAL_AUTH_ONLY) else 0) | (if (o.REMOTE_AUTH_ONLY == 1) @intFromEnum(IKEEXT_EAP_AUTHENTICATION_FLAGS.REMOTE_AUTH_ONLY) else 0)));
    }
};
