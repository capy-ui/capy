...
pub const CWP_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(CWP_FLAGS, (if (o.ALL == 1) @intFromEnum(CWP_FLAGS.ALL) else 0) | (if (o.SKIPINVISIBLE == 1) @intFromEnum(CWP_FLAGS.SKIPINVISIBLE) else 0) | (if (o.SKIPDISABLED == 1) @intFromEnum(CWP_FLAGS.SKIPDISABLED) else 0) | (if (o.SKIPTRANSPARENT == 1) @intFromEnum(CWP_FLAGS.SKIPTRANSPARENT) else 0));
    }
};
...
pub const MENU_ITEM_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(MENU_ITEM_FLAGS, (if (o.BYCOMMAND == 1) @intFromEnum(MENU_ITEM_FLAGS.BYCOMMAND) else 0) | (if (o.BYPOSITION == 1) @intFromEnum(MENU_ITEM_FLAGS.BYPOSITION) else 0) | (if (o.BITMAP == 1) @intFromEnum(MENU_ITEM_FLAGS.BITMAP) else 0) | (if (o.CHECKED == 1) @intFromEnum(MENU_ITEM_FLAGS.CHECKED) else 0) | (if (o.DISABLED == 1) @intFromEnum(MENU_ITEM_FLAGS.DISABLED) else 0) | (if (o.GRAYED == 1) @intFromEnum(MENU_ITEM_FLAGS.GRAYED) else 0) | (if (o.MENUBARBREAK == 1) @intFromEnum(MENU_ITEM_FLAGS.MENUBARBREAK) else 0) | (if (o.MENUBREAK == 1) @intFromEnum(MENU_ITEM_FLAGS.MENUBREAK) else 0) | (if (o.OWNERDRAW == 1) @intFromEnum(MENU_ITEM_FLAGS.OWNERDRAW) else 0) | (if (o.POPUP == 1) @intFromEnum(MENU_ITEM_FLAGS.POPUP) else 0) | (if (o.SEPARATOR == 1) @intFromEnum(MENU_ITEM_FLAGS.SEPARATOR) else 0) | (if (o.CHANGE == 1) @intFromEnum(MENU_ITEM_FLAGS.CHANGE) else 0) | (if (o.DELETE == 1) @intFromEnum(MENU_ITEM_FLAGS.DELETE) else 0) | (if (o.REMOVE == 1) @intFromEnum(MENU_ITEM_FLAGS.REMOVE) else 0) | (if (o.SYSMENU == 1) @intFromEnum(MENU_ITEM_FLAGS.SYSMENU) else 0) | (if (o.HELP == 1) @intFromEnum(MENU_ITEM_FLAGS.HELP) else 0) | (if (o.MOUSESELECT == 1) @intFromEnum(MENU_ITEM_FLAGS.MOUSESELECT) else 0));
    }
};
...
pub const SCROLLBAR_CONSTANTS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(SCROLLBAR_CONSTANTS, (if (o.CTL == 1) @intFromEnum(SCROLLBAR_CONSTANTS.CTL) else 0) | (if (o.HORZ == 1) @intFromEnum(SCROLLBAR_CONSTANTS.HORZ) else 0) | (if (o.VERT == 1) @intFromEnum(SCROLLBAR_CONSTANTS.VERT) else 0) | (if (o.BOTH == 1) @intFromEnum(SCROLLBAR_CONSTANTS.BOTH) else 0));
    }
};
...
pub const IMAGE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(IMAGE_FLAGS, (if (o.CREATEDIBSECTION == 1) @intFromEnum(IMAGE_FLAGS.CREATEDIBSECTION) else 0) | (if (o.DEFAULTCOLOR == 1) @intFromEnum(IMAGE_FLAGS.DEFAULTCOLOR) else 0) | (if (o.DEFAULTSIZE == 1) @intFromEnum(IMAGE_FLAGS.DEFAULTSIZE) else 0) | (if (o.LOADFROMFILE == 1) @intFromEnum(IMAGE_FLAGS.LOADFROMFILE) else 0) | (if (o.LOADMAP3DCOLORS == 1) @intFromEnum(IMAGE_FLAGS.LOADMAP3DCOLORS) else 0) | (if (o.LOADTRANSPARENT == 1) @intFromEnum(IMAGE_FLAGS.LOADTRANSPARENT) else 0) | (if (o.MONOCHROME == 1) @intFromEnum(IMAGE_FLAGS.MONOCHROME) else 0) | (if (o.SHARED == 1) @intFromEnum(IMAGE_FLAGS.SHARED) else 0) | (if (o.VGACOLOR == 1) @intFromEnum(IMAGE_FLAGS.VGACOLOR) else 0) | (if (o.COPYDELETEORG == 1) @intFromEnum(IMAGE_FLAGS.COPYDELETEORG) else 0) | (if (o.COPYFROMRESOURCE == 1) @intFromEnum(IMAGE_FLAGS.COPYFROMRESOURCE) else 0) | (if (o.COPYRETURNORG == 1) @intFromEnum(IMAGE_FLAGS.COPYRETURNORG) else 0));
    }
};
...
pub const SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS, (if (o.UPDATEINIFILE == 1) @intFromEnum(SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS.UPDATEINIFILE) else 0) | (if (o.SENDCHANGE == 1) @intFromEnum(SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS.SENDCHANGE) else 0));
    }
};
...
pub const MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS, (if (o.NONE == 1) @intFromEnum(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.NONE) else 0) | (if (o.ALERTABLE == 1) @intFromEnum(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.ALERTABLE) else 0) | (if (o.INPUTAVAILABLE == 1) @intFromEnum(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.INPUTAVAILABLE) else 0) | (if (o.WAITALL == 1) @intFromEnum(MSG_WAIT_FOR_MULTIPLE_OBJECTS_EX_FLAGS.WAITALL) else 0));
    }
};
...
pub const LAYERED_WINDOW_ATTRIBUTES_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(LAYERED_WINDOW_ATTRIBUTES_FLAGS, (if (o.ALPHA == 1) @intFromEnum(LAYERED_WINDOW_ATTRIBUTES_FLAGS.ALPHA) else 0) | (if (o.COLORKEY == 1) @intFromEnum(LAYERED_WINDOW_ATTRIBUTES_FLAGS.COLORKEY) else 0));
    }
};
...
pub const PEEK_MESSAGE_REMOVE_TYPE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(PEEK_MESSAGE_REMOVE_TYPE, (if (o.NOREMOVE == 1) @intFromEnum(PEEK_MESSAGE_REMOVE_TYPE.NOREMOVE) else 0) | (if (o.REMOVE == 1) @intFromEnum(PEEK_MESSAGE_REMOVE_TYPE.REMOVE) else 0) | (if (o.NOYIELD == 1) @intFromEnum(PEEK_MESSAGE_REMOVE_TYPE.NOYIELD) else 0) | (if (o.QS_INPUT == 1) @intFromEnum(PEEK_MESSAGE_REMOVE_TYPE.QS_INPUT) else 0) | (if (o.QS_POSTMESSAGE == 1) @intFromEnum(PEEK_MESSAGE_REMOVE_TYPE.QS_POSTMESSAGE) else 0) | (if (o.QS_PAINT == 1) @intFromEnum(PEEK_MESSAGE_REMOVE_TYPE.QS_PAINT) else 0) | (if (o.QS_SENDMESSAGE == 1) @intFromEnum(PEEK_MESSAGE_REMOVE_TYPE.QS_SENDMESSAGE) else 0));
    }
};
...
pub const CASCADE_WINDOWS_HOW = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(CASCADE_WINDOWS_HOW, (if (o.SKIPDISABLED == 1) @intFromEnum(CASCADE_WINDOWS_HOW.SKIPDISABLED) else 0) | (if (o.ZORDER == 1) @intFromEnum(CASCADE_WINDOWS_HOW.ZORDER) else 0));
    }
};
...
pub const GET_MENU_DEFAULT_ITEM_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(GET_MENU_DEFAULT_ITEM_FLAGS, (if (o.GOINTOPOPUPS == 1) @intFromEnum(GET_MENU_DEFAULT_ITEM_FLAGS.GOINTOPOPUPS) else 0) | (if (o.USEDISABLED == 1) @intFromEnum(GET_MENU_DEFAULT_ITEM_FLAGS.USEDISABLED) else 0));
    }
};
...
pub const MOUSEHOOKSTRUCTEX_MOUSE_DATA = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(MOUSEHOOKSTRUCTEX_MOUSE_DATA, (if (o.@"1" == 1) @intFromEnum(MOUSEHOOKSTRUCTEX_MOUSE_DATA.@"1") else 0) | (if (o.@"2" == 1) @intFromEnum(MOUSEHOOKSTRUCTEX_MOUSE_DATA.@"2") else 0));
    }
};
...
pub const FLASHWINFO_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(FLASHWINFO_FLAGS, (if (o.ALL == 1) @intFromEnum(FLASHWINFO_FLAGS.ALL) else 0) | (if (o.CAPTION == 1) @intFromEnum(FLASHWINFO_FLAGS.CAPTION) else 0) | (if (o.STOP == 1) @intFromEnum(FLASHWINFO_FLAGS.STOP) else 0) | (if (o.TIMER == 1) @intFromEnum(FLASHWINFO_FLAGS.TIMER) else 0) | (if (o.TIMERNOFG == 1) @intFromEnum(FLASHWINFO_FLAGS.TIMERNOFG) else 0) | (if (o.TRAY == 1) @intFromEnum(FLASHWINFO_FLAGS.TRAY) else 0));
    }
};
...
pub const MENUINFO_STYLE = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(MENUINFO_STYLE, (if (o.AUTODISMISS == 1) @intFromEnum(MENUINFO_STYLE.AUTODISMISS) else 0) | (if (o.CHECKORBMP == 1) @intFromEnum(MENUINFO_STYLE.CHECKORBMP) else 0) | (if (o.DRAGDROP == 1) @intFromEnum(MENUINFO_STYLE.DRAGDROP) else 0) | (if (o.MODELESS == 1) @intFromEnum(MENUINFO_STYLE.MODELESS) else 0) | (if (o.NOCHECK == 1) @intFromEnum(MENUINFO_STYLE.NOCHECK) else 0) | (if (o.NOTIFYBYPOS == 1) @intFromEnum(MENUINFO_STYLE.NOTIFYBYPOS) else 0));
    }
};
...
pub const WINDOWPLACEMENT_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(WINDOWPLACEMENT_FLAGS, (if (o.ASYNCWINDOWPLACEMENT == 1) @intFromEnum(WINDOWPLACEMENT_FLAGS.ASYNCWINDOWPLACEMENT) else 0) | (if (o.RESTORETOMAXIMIZED == 1) @intFromEnum(WINDOWPLACEMENT_FLAGS.RESTORETOMAXIMIZED) else 0) | (if (o.SETMINPOSITION == 1) @intFromEnum(WINDOWPLACEMENT_FLAGS.SETMINPOSITION) else 0));
    }
};
...
pub const MENUINFO_MASK = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(MENUINFO_MASK, (if (o.APPLYTOSUBMENUS == 1) @intFromEnum(MENUINFO_MASK.APPLYTOSUBMENUS) else 0) | (if (o.BACKGROUND == 1) @intFromEnum(MENUINFO_MASK.BACKGROUND) else 0) | (if (o.HELPID == 1) @intFromEnum(MENUINFO_MASK.HELPID) else 0) | (if (o.MAXHEIGHT == 1) @intFromEnum(MENUINFO_MASK.MAXHEIGHT) else 0) | (if (o.MENUDATA == 1) @intFromEnum(MENUINFO_MASK.MENUDATA) else 0) | (if (o.STYLE == 1) @intFromEnum(MENUINFO_MASK.STYLE) else 0));
    }
};
...
pub const DI_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(DI_FLAGS, (if (o.MASK == 1) @intFromEnum(DI_FLAGS.MASK) else 0) | (if (o.IMAGE == 1) @intFromEnum(DI_FLAGS.IMAGE) else 0) | (if (o.NORMAL == 1) @intFromEnum(DI_FLAGS.NORMAL) else 0) | (if (o.COMPAT == 1) @intFromEnum(DI_FLAGS.COMPAT) else 0) | (if (o.DEFAULTSIZE == 1) @intFromEnum(DI_FLAGS.DEFAULTSIZE) else 0) | (if (o.NOMIRROR == 1) @intFromEnum(DI_FLAGS.NOMIRROR) else 0));
    }
};
