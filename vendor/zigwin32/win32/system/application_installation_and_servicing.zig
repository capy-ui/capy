...
pub const QUERYASMINFO_FLAGS = enum(u32) {
    ...
    pub fn initFlags(o: struct {
        ...
        return @enumFromInt(QUERYASMINFO_FLAGS, (if (o.E == 1) @intFromEnum(QUERYASMINFO_FLAGS.E) else 0));
    }
};
